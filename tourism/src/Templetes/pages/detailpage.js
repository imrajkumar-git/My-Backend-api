...
import {myFunction} from './js/custom/script';
import 'aos';
...
useEffect(()=>{
  ...
  axios.get(`http://192.168.43.203:8888/api/products/${id1}`)
...
return(
  ...
  <div className="row row-cols-md-2 bg">
    ...
    <div className="col-md-6 mt-2">
      ...
      <p className="mb-2 text-muted text-uppercase small"><h6>Catagory:{newapi.slug}</h6></p>
      ...
      <div className="table-responsive">
        <table className="table table-sm table-borderless mb-0">
          <tbody>
            <tr>
              <th className="pl-0 w-25" scope="row"><h5><b> Available:</b></h5> </th>
              <td>Overall Nepal</td>
            </tr>
          </tbody>
        </table>
