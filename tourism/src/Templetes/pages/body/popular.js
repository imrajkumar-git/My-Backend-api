...
const Popular = ()=>{
  ...
  axios.get(`http://192.168.43.203:8888/api/visit/${1}`)
  ...
  axios.get(`http://192.168.43.203:8888/api/visit/${2}`)
  ...
  axios.get(`http://192.168.43.203:8888/api/visit/${3}`)
  ...
  axios.get(`http://192.168.43.203:8888/api/visit/${4}`)
